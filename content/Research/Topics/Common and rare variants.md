...
**Common variants.** They are detected by association studies in large samples; because individual effects are small, millions of variants must be tested and results must be replicated. [[F67 NHGRI GWAS fact sheet#^f67-design|GWAS fact sheet]] [[F67 NHGRI GWAS fact sheet#^f67-scale|GWAS fact sheet]]

**Rare variants.** They are detected by sequencing, often in families or case-parent designs, and are enriched for coding changes with clearer functional interpretation. [[P31981491 Satterstrom 2020 Autism exome sequencing#^p31981491-model|Autism exome sequencing]] [[P31981491 Satterstrom 2020 Autism exome sequencing#^p31981491-genes|Autism exome sequencing]]

**Why both matter.** A condition can be influenced by both regimes at once, which is why association results and sequencing results are complementary rather than competing. [[F67 NHGRI GWAS fact sheet#^f67-meaning|GWAS fact sheet]]
...
> [!info]- In depth: two architectures that need different tools
> **Common variants.** Individually small effects, discovered by association studies and aggregated into polygenic scores; they explain a substantial share of population-level variation in many traits and very little about any one person. Complex traits are highly polygenic with individual common-disease odds ratios often near 1.01, which is why credible signals require very large samples and replication. [[P28686856 Visscher 2017 10 years of GWAS discovery#^p28686856-polygenic|10 years of GWAS discovery]] [[F67 NHGRI GWAS fact sheet#^f67-scale|GWAS fact sheet]] [[P28686856 Visscher 2017 10 years of GWAS discovery#^p28686856-prs|10 years of GWAS discovery]]
>
> **Rare variants.** Larger effects, found by sequencing, often de novo and enriched in constrained genes; in autism exome work the identified risk genes clustered in gene regulation and neuronal communication and were expressed early in development, with 102 risk genes meeting the study's threshold. [[P31981491 Satterstrom 2020 Autism exome sequencing#^p31981491-genes|Autism exome sequencing]] [[P31981491 Satterstrom 2020 Autism exome sequencing#^p31981491-model|Autism exome sequencing]]
>
> **Why the two are not alternatives.** Complex traits are highly polygenic while rare variants with larger effects surface in sequencing studies; both contribute to the same conditions, and ascertainment determines which architecture a particular sample reveals - the autism exome analysis identified partly different gene sets depending on how participants were ascertained (severe developmental delay versus autism). [[P28686856 Visscher 2017 10 years of GWAS discovery#^p28686856-polygenic|10 years of GWAS discovery]] [[P31981491 Satterstrom 2020 Autism exome sequencing#^p31981491-subgroups|Autism exome sequencing]]
>
> **Convergence and divergence.** Cell-type analyses in bipolar disorder implicate GABAergic interneurons and medium spiny neurons, with common and rare variant signals converging on the same genes - evidence that the two architectures can meet at the level of biology even when they are detected differently. [[P39843750 O'Connell 2025 Genomics of bipolar disorder#^p39843750-cells|Genomics of bipolar disorder]] [[P29844615 Schaid 2018 Fine-mapping#^p29844615-methods|Fine-mapping]]
>
