...
**Passive spread and decay.** A synaptic input produces a local graded potential that decays as it travels toward the soma, so distance attenuates influence. [[F51 OpenStax Function of nervous tissue#^f51-graded|Function of Nervous Tissue]] **Summation.** Inputs that arrive close together in time and space add, which is why spatial and temporal summation are the standard description of how a neuron reaches threshold. [[F51 OpenStax Function of nervous tissue#^f51-summation|Function of Nervous Tissue]] **Trigger zone.** Graded potentials converge at the initial segment of the axon, where voltage-gated sodium channels are dense; that site converts summed input into an all-or-none output. [[F04 OpenStax Communication between neurons#^f04-initial-segment|Communication Between Neurons]]
...
>
> **From local voltages to a decision.** Each active synapse produces a graded potential whose size depends on the stimulus and the synapse's distance from the soma, and these potentials decay with distance. They summate in space and time, and the combined effect at the trigger zone decides whether the cell fires. This is why dendritic geometry - where a synapse sits, and how far its current must travel - is part of the computation rather than an implementation detail. [[F51 OpenStax Function of nervous tissue#^f51-graded|Function of Nervous Tissue]] [[F51 OpenStax Function of nervous tissue#^f51-summation|Function of Nervous Tissue]] [[F04 OpenStax Communication between neurons#^f04-initial-segment|Communication Between Neurons]]
>
...
>
> **Plasticity changes the arithmetic.** Short-term facilitation and depression alter how successive inputs summate over hundreds of milliseconds, while lasting changes in spine structure alter the surface available for contact on longer timescales. Integration and plasticity are therefore the same process viewed at different time constants rather than two separate stages. [[F100 Neuroscience Online synaptic plasticity#^f100-facilitation|Synaptic Plasticity]] [[F102 Neuroscience Online cell types#^f102-spines|Organization of Cell Types]]
>
> **Non-linear dendrites, labelled as a model.** The strongest statements about dendritic computation - branch-level spikes, coincidence detection in thin dendrites - come from reduced preparations and modelling, and the introductory treatments used here present linear summation as the baseline case. A defensible reading is that summation describes most textbook situations, that non-linear dendritic events are established in specific cell types, and that generalising either level to all neurons is unwarranted. [[F51 OpenStax Function of nervous tissue#^f51-limit|Function of Nervous Tissue]] [[F04 OpenStax Communication between neurons#^f04-caution-summation|AI synthesis: Communication Between Neurons]]
>
...
>
> **What plasticity changes about the arithmetic.** Input specificity in lasting plasticity makes sense against this geometry: a change confined to active synapses alters the local sum on one branch without rewriting the cell's whole input map, and structural spine changes adjust the receiving surface for exactly the contacts that were active. Integration and plasticity therefore share a timescale ladder - summation over milliseconds, short-term changes over seconds, structural change over days - and a claim about 'strengthening a synapse' is incomplete until its rung is named. [[F102 Neuroscience Online cell types#^f102-spines|Organization of Cell Types]] [[Short-term synaptic plasticity]] [[Long-term potentiation and depression]]
>
