...
**Definition.** A measurement tool is reliable when it produces consistent scores and valid when it measures the construct it claims to measure in a defined population and purpose. [[P29942800 Boateng 2018 Developing and validating scales#^p29942800-phases|Developing and Validating Scales]]

## Supported claims

- Scale development runs through three phases and nine steps: item generation with content validity, scale construction with pre-testing, sampling, item reduction and dimensionality, and evaluation of reliability and validity. [[P29942800 Boateng 2018 Developing and validating scales#^p29942800-phases|P29942800]]
