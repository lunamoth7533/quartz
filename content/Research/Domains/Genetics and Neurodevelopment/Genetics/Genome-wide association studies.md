...
**Design.** A genome-wide association study compares variants across a large sample to find markers statistically associated with a trait, without assuming which gene is involved: researchers genotype many individuals, compare variant frequencies between groups or against a continuous trait, and apply a stringent significance threshold because of the number of tests. [[F67 NHGRI GWAS fact sheet#^f67-design|GWAS fact sheet]]

**Interpretation.** A significant signal marks a genomic region associated with the trait in that population; it does not by itself identify the causal variant or the gene, or show how the variant acts. [[F67 NHGRI GWAS fact sheet#^f67-meaning|GWAS fact sheet]] [[F67 NHGRI GWAS fact sheet#^f67-limit|GWAS fact sheet]]

**Scale, power and replication.** Most complex-trait effects are small, so very large samples and replication are required before a signal is credible. [[F67 NHGRI GWAS fact sheet#^f67-scale|GWAS fact sheet]] Power depends on the number of loci, their effect sizes, sample size, genotyping panel and trait measurement. [[P28686856 Visscher 2017 10 years of GWAS discovery#^p28686856-design|10 years of GWAS discovery]]
...
**What the enterprise produced.** Roughly ten thousand robust trait-variant associations across hundreds of traits, evidence that complex traits are highly polygenic, and a narrowing of the missing-heritability gap as samples grew - height variants explained more than twenty percent of heritability by 2014. [[P28686856 Visscher 2017 10 years of GWAS discovery#^p28686856-discovery|10 years of GWAS discovery]] [[P28686856 Visscher 2017 10 years of GWAS discovery#^p28686856-heritability|10 years of GWAS discovery]] Those associations are less valuable as individual findings than as a population map: they establish which traits are polygenic, which loci are shared across traits, and where the biology of unexpected pairs intersects. That map-level reading is what turned GWAS from a gene-hunting tool into an architecture-description tool, and it is the reading the psychiatric-genomics results in this library depend on. The review also covers prediction, causal inference such as Mendelian randomisation, and biological follow-up, so the design feeds several downstream literatures. [[P28686856 Visscher 2017 10 years of GWAS discovery#^p28686856-translation|10 years of GWAS discovery]]

**Portability.** The field's data are dominated by European-ancestry samples, which limits portability of effect estimates elsewhere: a well-powered study in one ancestry group is not automatically informative for another. [[P28686856 Visscher 2017 10 years of GWAS discovery#^p28686856-limit|10 years of GWAS discovery]]
