...
Evidence about decisions is subject to the general replication problem. Many classic findings were established in small samples, and a large multi-team replication project found replication effect sizes averaging about half the original magnitudes, so effect sizes should be read with the same caution as elsewhere in psychology - a caution that applies with force to laboratory decision paradigms. [[P26315443 Open Science Collaboration 2015 Reproducibility#^p26315443-result|Estimating the reproducibility of psychological science]] The reproducible-science literature attributes such patterns to incentives, publication practices and analysis flexibility rather than to individual misconduct. [[P33954258 Munafo 2017 Reproducible science#^p33954258-metadata|A manifesto for reproducible science]]
