---
note_type: topic
title: "Reviews, guidelines and preprints"
...
description: "How systematic reviews, guidelines and preprints differ in evidential weight, and what to check before relying on any of them."
secondary_domain: []
reviewed: 2026-09-25
---
...
**Definition.** Reviews, consensus statements and clinical guidelines summarize bodies of evidence, which makes them efficient entry points and one layer removed from the primary data. [[P33549739 Faraone 2021 World Federation ADHD consensus statement#^p33549739-scope|World Federation ADHD consensus statement]]
...
**Systematic reviews.** A systematic review is a method: it follows an explicit protocol and search strategy, and where those are missing the review is closer to a long narrative article. PRISMA specifies what such a review should report so readers can assess what was done, including a flow diagram documenting how records were identified, screened, excluded and included. Reporting completeness governs auditability, not quality - a review can be fully reported and still rest on biased studies. [[P33782057 PRISMA 2020#^p33782057-purpose|PRISMA 2020]] [[P33782057 PRISMA 2020#^p33782057-items|PRISMA 2020]] [[P33782057 PRISMA 2020#^p33782057-flow|PRISMA 2020]] [[P33782057 PRISMA 2020#^p33782057-limit|PRISMA 2020]]

**Reviews of reviews.** Reviews of the same question can disagree because of inclusion criteria, outcome selection and synthesis method, so reading the methods section is not optional. [[F129 Cochrane Handbook Chapter 10#^f129-overview|Cochrane Handbook chapter 10]]

**Certainty is graded separately from the recommendation.** Guidelines add value judgements to evidence - cost, feasibility, equity - which is why GRADE separates the certainty of evidence from the strength of a recommendation: a strong recommendation can rest on low-certainty evidence where values and context justify it, and certainty is rated down for risk of bias, inconsistency, indirectness, imprecision and publication bias. Reading a guideline means reading both columns. [[P18436948 Guyatt 2008 GRADE#^p18436948-certainty|GRADE]] [[P18436948 Guyatt 2008 GRADE#^p18436948-domains|GRADE]] [[P18436948 Guyatt 2008 GRADE#^p18436948-use|GRADE]]
...
**Cross-domain connection (curation).** Guideline reading is a condition-domain skill: the bipolar, ADHD and autism guidelines in this library each rest on a specific evidence review, so the reading rules described here (name the certainty, the review, the service context) are what make those documents usable. [[Phase-specific bipolar treatment evidence]] [[ADHD diagnosis and measurement]]
...
Choose one recommendation in the bipolar guideline note and trace which study type would be needed to verify it directly.

## Detailed lesson

- [[Lesson - Reviews, guidelines and preprints]] - full lesson with a plain-language model, worked example, misconceptions, source boundaries and practice questions.
