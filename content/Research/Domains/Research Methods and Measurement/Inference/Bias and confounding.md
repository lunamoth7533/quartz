...
**Confounding.** A third variable that influences both exposure and outcome distorts the comparison and produces an association that no amount of statistical significance will fix. Randomisation addresses it - which is why random assignment and preregistered outcomes matter - and observational designs must measure and model it. [[F09 Noba Research designs#^f09-confounds|Research Designs]]

**Selection.** The textbook treatment pairs confounding with selection effects, which arise when who enters the study depends on both sides of the comparison. Who enters a study determines what can be estimated, which is why sampling frames and attrition matter as much as analysis. [[F09 Noba Research designs#^f09-designs|Research Designs]]
...
**Analytic flexibility as a bias source.** Many defensible analytic choices create opportunities for results to depend on the analysis path, and in neuroimaging analytic flexibility - many defensible choices in preprocessing and modelling - is identified as a central source of irreproducibility. [[P28053326 Poldrack 2017 Neuroimaging reproducibility#^p28053326-flexibility|Neuroimaging reproducibility]] Preregistration and specification-curve methods exist to make that visible, and the proposed responses also include data and code sharing, larger samples and multiverse analyses. [[P29531091 Nosek 2018 Preregistration revolution#^p29531091-distinction|The preregistration revolution]] [[P28053326 Poldrack 2017 Neuroimaging reproducibility#^p28053326-practice|Neuroimaging reproducibility]]

**Small studies with large effects.** Low statistical power produces unstable estimates that exaggerate effects when they reach significance - in neuroimaging it exaggerates effect sizes in published brain-behaviour correlations - a pattern documented in replication projects. [[P28053326 Poldrack 2017 Neuroimaging reproducibility#^p28053326-power|Neuroimaging reproducibility]] [[P26315443 Open Science Collaboration 2015 Reproducibility#^p26315443-result|Estimating the reproducibility of psychological science]]
